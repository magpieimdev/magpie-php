...
- PHPStan type analysis issues in hybrid API test suite
- Code style violations in ChargesResource and test files
- Missing trailing commas and string concatenation formatting
- Extra blank lines and whitespace inconsistencies

### Technical

- Enhanced type annotations for better static analysis compatibility
- Improved PHPDoc comments for hybrid API implementation
- Standardized code formatting across all PHP files
- Ensured full CI/CD pipeline compatibility for GitHub Actions
